...
import java.net.URL;
import org.hobbit.spatiotemporalbenchmark.data.oaei.OutputMappingsFormat;
...
public class OAEIAlignmentOutput extends OutputMappingsFormat {
    ...
    /**
     * Same format than OAEIRDFAlignmentFormat, but with different output. SEALS
     * requires the creation of a temporal file and returning its URL
     *
     * @param name
     */
