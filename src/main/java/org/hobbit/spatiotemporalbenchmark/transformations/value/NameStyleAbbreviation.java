 ...
 * @date 19/mag/2010 Changes a string as if it was a name of form First Second
 * Surname into the following supported formats: - NDOTS => F.S. Surname -
 * SCOMMANDOT => Surname, F.S. - ALLDOTS => F.S. S.
 */
public class NameStyleAbbreviation implements DataValueTransformation {
    ...
    public Object execute(Object arg) {
        String fbefore = (String) arg;
        String f = fbefore.trim().replaceAll(" +", " "); //replace more than one spaces with one
        while (f.startsWith(" ")) {
